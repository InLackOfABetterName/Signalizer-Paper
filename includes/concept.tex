...
\begin{figure}[ht]
  ...
  \caption{Error Correction Problem}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \caption{Prediction Network General Architecture Alternative 1}
...
\begin{figure}[!ht]
  ...
  \caption{Prediction Network General Architecture Alternative 2}
...
\begin{figure}[!ht]
  ...
  \caption{Class Diagram Prediction Network}
  \label{predictionNetwork}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \caption{Traffic Tracker Sensor Interface}
...
\begin{figure}[!ht]
  ...
  \caption{Traffic Tracker Error Correction}
...
\begin{figure}[!ht]
  ...
  \caption{Class Diagram Traffic Tracker}
  \label{trafficTracker}
\end{figure}
