...
\begin{figure}[ht]
	\centering
  \includegraphics[scale=0.65]{figures/neuron_structure}
...
\begin{figure}[ht]
	\centering
  \includegraphics[scale=0.6]{figures/activation_functions}
...
\begin{figure}[ht]
	\centering
  \includegraphics[scale=0.9]{figures/perceptron}
...
\begin{figure}[ht]
	\centering
  \includegraphics[scale=0.7]{figures/multilayer_XOR}
